...
This serves to augment the [Storage TAG Chair proposal
...
* [ ] Nomination
  ...
  * [ ] Storage TAG Meeting announcement -- all regions
  * [ ] TOC email list official nomination
  * [ ] #tag-storage slack message with a link to the email nomination
...
* [ ] Transfer Logistics
  ...
  * [ ] #tag-storage-cochairs channel - add new chair(s)
  * [ ] #tag-storage-cochairs-emeritus - add outgoing chair(s)
  * [ ] #tag-storage-toc-liaison - add new chair(s)
  ...
  * [ ] Choose new chair representative for Storage TAG [on-going
    projects](https://github.com/cncf/tag-storage#on-going-projects) if needed.
  * [ ] add chair to [github team](https://github.com/orgs/cncf/teams/sig-storage/)
  * [ ] tag-storage repo PR:
  ...
  * [ ] [TOC Repo update](https://github.com/cncf/toc/blob/main/tags/storage.md)
...
* [ ] Announce the vote
  * [ ] #tag-storage slack message
  * [ ] email message to the tag-storage list
  * [ ] Storage TAG meeting Announcement for each region
