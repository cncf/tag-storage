...
- Presentations are encouraged to expose the TAG to cloud native open source projects, cloud native storage concepts, and other cloud native or storage groups.
- Presentations should fit with [our charter](https://github.com/cncf/tag-storage/blob/main/governance/charter.md)
...
- Storage use-cases and case studies
