...
Members fulfilling any Roles in Storage TAG are responsible for understanding
...
among the Chairs may be escalated to a Storage TAG TOC Liaison.
...
The Storage TAG was formed with deeply technical Chairs based on early need
to navigate a complex storage landscape. If the TAG has less than two Technical
...
following the [Storage TAG's TL nomination
...
- Adhering to the [project process](https://github.com/cncf/tag-storage/blob/main/governance/process.md)
...
### Storage review facilitator

[Storage Reviews](/assessments) are part of the ongoing work of the group
and led by a Storage Assessment Facilitator, who will:

* coordinate storage review leads for upcoming storage assessments.
* identify and recommend storage reviewers.
* contribute to process improvements.
* review and merge PRs in the /assessments directory (ensuring co-chair review
  of significant process changes).
* triage issues related to storage assessments.
...
of the Triage Team.  Interested members should first join `#tag-storage-triage`
...
* participate on #tag-storage-triage slack channel.
...
* [Storage Reviewers](../assessments/guide/storage-reviewer.md)
